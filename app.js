...
const copy = {
  en: {
    ...
    videoIntro: 'The browser decodes every frame, restores the selected watermark area, and records a new local video without uploading your file.',
  ...
  bn: {
    ...
    videoIntro: 'ব্রাউজার প্রতিটি ফ্রেম ডিকোড করে নির্বাচিত ওয়াটারমার্ক অংশ পুনর্গঠন করবে এবং ফাইল আপলোড না করেই নতুন ভিডিও তৈরি করবে।',
